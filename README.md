...
**[math-magicians]** is a project where user can use a calculator and also find the quotes from an external API.
...
```
https://github.com/fpsapc/math-magicians
```
...
- **[How this project works]**
  ...
  - [You can use calculator and also read the quotes.]
